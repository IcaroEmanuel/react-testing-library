...
Neste projeto, foi desenvolvido testes para uma aplicação React com a finalidade de:
...
Este projeto foi desenvolvido durante o curso de Desenvolvimento Web FullStack da [Trybe](https://www.betrybe.com/)<br/>

# Tecnologias utilizadas
* React Testing Library<br/>
React Testing Library é um conjunto de utilitários que permitem testar componentes react<br/>
Para mais informações, consulte a [documentação](https://testing-library.com/docs/)
### Iniciando o projeto

1. Clone o repositório
2. Instale as dependências
  * `npm install`
# Lista de requisitos(Propostos pela [Trybe](https://www.betrybe.com/))
